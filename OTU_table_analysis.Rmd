...
```{r}
p <- phyloseq.extended:::ggrare(biom, step = 100, color = "state", label = "Sample", se = TRUE) + theme(aspect.ratio = 9 / 16)
```
...
print("SP stderr richness") 
sd(rich_stats[1:17,2])/sqrt(17)

print("NP stderr richness")
sd(rich_stats[18:24,2])/sqrt(7)

print("SP stderr diversity")
sd(diversity_stats[1:17,2])/sqrt(17)

print("NP stderr diversity")
